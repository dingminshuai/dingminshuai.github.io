...
[Home](./) | [CV](assets/Minshuai_Ding_CV_Public.pdf) | [Teaching](teaching.html) | [Applied Research](applied-research.html) | [Public Writing](public-writing.html)
...
My current 50-state project uses the federally mandated **National Youth in Transition Database (NYTD)** to compare evidence production and documented evidence incorporation across U.S. state governments.
...
- Olson, K., Ding, M., & Ganshert, A. (2026). The effects of Spanish-language materials in a local area ABS mixed-mode survey on response rates and sample composition: An experiment. In M. Sha & E. Aizpurua (Eds.), *Cross-Cultural Research in Practice* (pp. 117–134). Amazon Digital Services LLC-KDP. (Reprinted from *Survey Practice*.)

- Ding, M. (2025). Turning the page: When a library becomes a special district. In R. Blair & K. Nelson (Eds.), *Managing Local Government: Cases in Effectiveness* (2nd ed.). International City/County Management Association (ICMA).

- Ding, M. (2023). Mobile communication as disaster response infrastructure for cross-sector coproduction: A field study of mobile apps in China flood seasons. In M. Xie & C.-C. Chao (Eds.), *Mobile Communication in Asian Society and Culture: Continuity and Changes across Private, Organizational, and Public Spheres* (pp. 59–80). Routledge. [DOI](https://doi.org/10.4324/9781003328896-7)

## Selected Other Scholarly Publications

- Piper, R. K., & Ding, M. (2018). *Abolishing 21st century enslavement: Capitalism’s pattern of labor abuse during economic shifts and restructuring (1840–present).* Center for Public Affairs Research Report No. 416, University of Nebraska at Omaha.

- Piper, R. K., & Ding, M. (2017). *A “not-so radical” urban political-economic narrative: Transforming failed liberal and conservative approaches to poverty and related social problems.* Center for Public Affairs Research Report No. 403, University of Nebraska at Omaha.

## Methods

My methodological work includes probability and address-based sampling, mixed-mode data collection, questionnaire design, survey experiments, nonresponse analysis, weighting, regression, social network analysis, text analysis, field studies, in-depth interviews, and qualitative research design. I work primarily with Stata, SPSS, Qualtrics, WinCATI, and Excel.

For additional details, see my [CV](assets/Minshuai_Ding_CV_Public.pdf) or [Google Scholar](https://scholar.google.com/citations?user=xLLOB-oAAAAJ).
